...
public class Main {
	 ...
	 */
	enum GameInfo {
		CONNECTN("cn", "ConnectN"), TicTacToe("ttt", "Tic-Tac-Toe"), Ataxx("ataxx", "Ataxx"), AdvancedTicTacToe("attt", "Advanced Tic-Tac-Toe");
	...
	private static void parseGameOption(CommandLine line) throws ParseException {
		...
		case Ataxx:
			if (dimRows != null && dimCols != null && dimObs != null) {
				gameFactory = new AtaxxFactory(dimRows, dimCols, dimObs);
			} else {
